        ...
        <section className='simpleSteps' id='simpleSteps'>
            <div className='wrapper'>
                <div className='simpleSteps__container'>
                    ...
                    <img data-aos="fade-up-right" className='simpleSteps__decoration' src={decoration} alt='decoration'/>
                    <div className='simpleSteps__content'>
                        <div className='simpleSteps__firstContent'>
                            ...
                            <span> </span>
                            <p data-aos="flip-left" className='simpleSteps__text'>ubrania, zabawki, sprzęt i inne</p>
                        </div>
                        ...
                        <div className='simpleSteps__fourContent'>
                            ...
                            <span> </span>
                            <p data-aos="flip-left" className='simpleSteps__text'>kurier przyjedzie w dogodnym terminie</p>
                        </div>
                    </div>
                    <button data-aos="flip-left" className="big-btn"><Link to="Login">ODDAJ<br/>RZECZY</Link></button>
                </div>
            </div>
        </section>
    )
